...
def load_contract(path: Path) -> dict[str, Any]:
    ...
    require(value.get("faiss_version") == "1.13.2" and value.get("parent_intrinsic_evidence_sha256") == "edad3119c95708101f4064270b244f9b6af7842dc32f9d1ab1bd9f142f6615e4", "overcomplete centroid parent evidence differs")
