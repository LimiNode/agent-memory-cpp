...
def train(args:Any)->None:
 ...
 artifact={'schema_version':1,'trainer':{'id':'agent-memory-cpp:mih-asymmetric-query-projection-trainer','source_files_sha256':source_hashes()},'input_materialization_manifest_sha256':data['manifest_sha256'],'prepared_study_manifest_sha256':data['manifest']['prepared_study_manifest_sha256'],'architecture':{'family':'mih_query_aware_asymmetric_projection_v1','input_dimension':384,'bit_count':256,'band_count':16,'band_width_bits':16,'shared_projection':False,'document_side':'frozen_full_itq_w0_v1','query_side':'learned_train_qrels_projection_v1'},'training':{'seed':args.seed,'queries_or_qrels_used':True,'objective':'frozen_document_itq_query_projection_with_train_mih_false_positive_mining_v1','itq_iterations':args.itq_iterations,'positive_radius':56,'negative_radius':80,'hard_negative_mining':{'id':'train_mih_candidate_union_false_positive_v1','count':args.hard_negative_count},'held_out_exclusion':{'id':'external_excluded_document_ids_set_v1','document_ids_set_sha256':exclusion}},'weights':{}}
