...
def main()->int:
 ...
 try:
  ...
  for seed in contract['seeds']:
   ...
   value=json.loads(artifact.read_text());need(value['architecture']['family']=='mih_query_aware_asymmetric_projection_v1' and value['training']['hard_negative_mining']['id']=='train_mih_candidate_union_false_positive_v1','artifact contract differs')
