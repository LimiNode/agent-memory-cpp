...
def load_contract(path: Path)->dict[str,Any]:
    ...
    require(v.get("opq")=={"subquantizers":8,"bits_per_subquantizer":2,"iterations":25,"seed":20260828,"training_source":"frozen_train_e5_vectors_only"} and v.get("cascade")=={"hamming_limit":768,"adc_limit":256,"exact_limit":256,"oracle_k":10} and v.get("exploratory_gate")=={"minimum_e5_oracle_survival_after_adc":.70,"meaning":"below_this_gate_freeze_rotated_product_branch"} and v.get("confirmation")=="forbidden" and v.get("library_dependency")=="forbidden_faiss_is_external_benchmark_only", "rotated product scope differs")
    return v
def main()->int:
