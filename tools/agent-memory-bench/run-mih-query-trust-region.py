...
def expected_execution_contract(contract: dict[str, Any], training_root: Path) -> dict[str, Any]:
    ...
    values = {
        ...
        "routing_estimator": train.get("routing_estimator", "sampled-band-radius-soft-collision-v1"),
        "routing_strata": train.get("routing_strata", 4),
        "routing_pool_per_stratum": train.get("routing_pool_per_stratum", 512),
