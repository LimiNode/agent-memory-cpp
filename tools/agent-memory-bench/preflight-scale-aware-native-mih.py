...
def load_contract(path: Path) -> dict[str, Any]:
    ...
    require(value.get("calibration_dataset") == {"language": "es", "split": "dev", "sampling_seed": 20260825, "train_documents": 25000, "evaluation_queries": 0, "status": "pending_materialization_manifest_freeze"}, "scale-aware calibration data contract differs")
