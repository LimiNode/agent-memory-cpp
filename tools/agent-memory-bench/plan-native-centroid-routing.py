...
def load_contract(path: Path) -> dict[str, Any]:
    ...
    require(value.get("hnsw") == {"connectivity": [8, 16], "ef_construction": 200, "ef_search": [256, 512, 2048, 8192]} and value.get("timing") == {"warmup_repeats": 2, "measured_repeats": 7, "concurrency": "single_native_routing_thread_v1", "scope": "warm_in_memory_native_centroid_routing_only_excludes_query_embedding_document_cascade_and_index_build_v1"}, "native centroid routing timing matrix differs")
