...
agent_memory_documents|ingestion|KeyValueTable|indexed_retrieval|kv_supported|logical_adapter_required|DocumentId|1
agent_memory_chunks|ingestion|KeyValueTable|indexed_retrieval|kv_supported|logical_adapter_required|ChunkId|1
agent_memory_document_chunks|ingestion|KeyValueTable|indexed_retrieval|kv_supported|logical_adapter_required|DocumentId|1
agent_memory_resource_manifests|ingestion|KeyValueTable|indexed_retrieval|kv_supported|logical_adapter_required|ResourceId|1
agent_memory_resource_index_document_owners|ingestion|KeyValueTable|indexed_retrieval|kv_supported|logical_adapter_required|DocumentId|1
agent_memory_resource_index_chunk_owners|ingestion|KeyValueTable|indexed_retrieval|kv_supported|logical_adapter_required|ChunkId|1
