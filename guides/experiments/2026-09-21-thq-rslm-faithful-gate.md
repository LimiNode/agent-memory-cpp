...
The implementation is copied from the official Google Research notebook:

* repository commit `4700efb9afa54286b0e04473ba80a13e8461e25f`;
...
* `rslm2/3/4-faithful`: official relative mode, including the inner UE7M9
  codec scale and the outer UE7M9 full-vector norm correction;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| RSLM2 faithful | 100 | 196 | 0.936184 | 0.931579 | 0.645689 |
| RSLM2 local | 96 | 192 | 0.936184 | 0.930921 | 0.652428 |
| RSLM3 faithful | 148 | 244 | 0.969079 | 0.963158 | 0.656721 |
| RSLM3 local | 144 | 240 | 0.969737 | 0.963816 | 0.660116 |
| RSLM4 faithful | 196 | 292 | 0.985526 | 0.978947 | 0.659201 |
| RSLM4 local | 192 | 288 | 0.975000 | 0.969737 | 0.660974 |

For orientation only, the pre-existing Faiss RQ audit on the canonical seed
reports RQ32 `0.656683` at 128 total bytes and RQ48 `0.651655` at 144 total
bytes. Those numbers are not relabelled as a matched replay here: their
...
to the bounded local control but uses four additional side bytes and a much
