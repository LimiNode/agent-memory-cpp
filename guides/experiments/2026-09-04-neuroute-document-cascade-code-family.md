...
| Raw sign-208 Hamming control | 26 | .016 | .016 | .364 | .105 | .057 | .060 | .061 |
| THQ3 Gaussian-threshold control | 96 | .028 | .022 | .342 | .113 | .071 | .072 | .061 |
| THQ4 Gaussian-threshold control | 144 | .034 | .038 | .358 | .120 | .086 | .115 | .061 |
| THQ5 Gaussian-threshold control | 192 | .043 | .033 | .324 | .114 | .076 | .089 | .078 |

This is a kernel comparison, not a quality result: the records use a raw
sign-208 control and synthetic fixed Gaussian-threshold THQ encoders, not a
trained ITQ/ADC codec or the per-coordinate quantile tables from the quality
study. The native controls do not persist or load fitted thresholds and must
not be read as production encoders. The AVX2 nibble popcount is not universally faster
